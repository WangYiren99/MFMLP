function [] = dispCubeAshwin(h,datacube,brightness,mywl,labelss,cols,rows,writefile,grayc,resultname)



wltextposition = [5 230]; %[12 40];
m=size(datacube,3);
for ind=1:m
...
%                     text(textposition(1),textposition(2),['\bf' num2str(currentwl,4) ' nm'],'color','[1,1,0.9]','FontSize',40)
                else
                    if grayc==1
